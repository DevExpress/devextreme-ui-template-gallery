...
export const SalesPerformanceCard = ({
  ...
  onPeriodChanged: (e: DropDownButtonTypes.SelectionChangedEvent) => void;
  range: Date[];
}) => (
  <CardAnalytics
    ...
    additionalHeaderContent={
      <div className='sales-filter'>
        <DropDownButton
          ...
          onSelectionChanged={onPeriodChanged}
        />
      </div>
    }
  >
    <Chart id='chart' dataSource={datasource}>
      ...
      <Tooltip
        enabled
        customizeTooltip={(pointInfo) => ({ text: pointInfo['seriesName'] })}
      />
