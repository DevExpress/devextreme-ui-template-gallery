...
export const ChangeProfilePasswordForm = ({ visible, setVisible }) => {
  ...
  const onCurrentPasswordValidated = useCallback(
    (e: ValidatorTypes.ValidatedEvent) => {
      setCurrentPasswordValid(!!e.isValid);
    },
    []
  );

  const onConfirmedPasswordValidated = useCallback(
    (e: ValidatorTypes.ValidatedEvent) => {
  ...
  const onNewPasswordValidated = useCallback(
    (e: ValidatorTypes.ValidatedEvent) => {
