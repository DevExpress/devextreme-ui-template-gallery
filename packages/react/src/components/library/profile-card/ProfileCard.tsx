...
export const ProfileCard = ({
  ...
  const onFormFieldChange = (e: FormTypes.FieldDataChangedEvent) =>
    onFieldChange(e.dataField)(e.value);
  const itemsWithCommonOptions = useMemo(
    () =>
      items.map((item) => {
  ...
  const renderItems = useMemo(
    () =>
      itemsWithCommonOptions.map((item, index) => (
        <Item
          key={index}
