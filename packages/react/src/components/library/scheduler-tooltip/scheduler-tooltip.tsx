...
export const TooltipContentTemplate = ({
  ...
  const timeString = `${selectedAppointmentData.startDate.toLocaleString(
    undefined,
    dateOptions
  )} - ${selectedAppointmentData.endDate.toLocaleTimeString(
    undefined,
    timeOptions
  )}`;
