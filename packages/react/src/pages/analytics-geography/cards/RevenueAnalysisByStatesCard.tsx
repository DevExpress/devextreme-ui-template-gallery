...
export const RevenueAnalysisByStatesCard = ({ datasource }) => (
  <CardAnalytics title='Revenue Analysis by States' contentClass='sales-by-state-and-city' isLoading={!datasource.length}>
    <DataGrid dataSource={datasource} height={270}>
      ...
      <Column alignment='left' caption='Amount' dataField='total' dataType='number' format='currency' hidingPriority={1} />
      <Column
        alignment='left'
        caption='Percentage'
