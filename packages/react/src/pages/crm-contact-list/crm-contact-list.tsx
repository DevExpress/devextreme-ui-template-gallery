            ...
            >
              ...
              <Toolbar>
                ...
                <Item location={'before'} locateInMenu={'auto'}>
                  <DropDownButton dataSource={filterStatusList} stylingMode={'text'} width={160} selectedItemKey={status} useSelectMode={true} onSelectionChanged={filterByStatus}></DropDownButton>
                </Item>
