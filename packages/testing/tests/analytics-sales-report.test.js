  ...
  screenModes.forEach((screenMode) => {
    themeModes.forEach((themeMode) => {
      ...
      test(`Analytics Sales Report (${project}, embed=${embedded}, ${screenMode[0]}, ${themeMode})`, async (t) => {
        ...
        await takeScreenshot(`analytics-sales-report-month${postfix}`, 'body', { textDiffTreshold: 0.5 });
        ...
        if (isPeriodSelectorBoxVisible) {
          ...
          await t.wait(timeoutSecond);
          await takeScreenshot(`analytics-sales-report-day${postfix}`, 'body', { textDiffTreshold: 0.5 });
        }
