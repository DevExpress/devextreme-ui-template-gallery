...
@Component({
  selector: 'form-item-photo-uploader',
  template: `
    <div 
      id="uploader"
      [ngClass]="
...
export class FormItemPhotoUploaderComponent { 
...
@NgModule({
  ...
  declarations: [FormItemPhotoUploaderComponent],
  exports: [FormItemPhotoUploaderComponent],
})
export class FormItemPhotoUploaderModule { }
